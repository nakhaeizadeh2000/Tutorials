...
- Done:
  - Section 01/1 `1. What TypeScript Is and Why It Exists` (3 leaves) — created `README/TypeScript/01 TypeScript Fundamentals and Mental Model/sections/1. What TypeScript Is and Why It Exists/1.1. What TypeScript Is vs JavaScript erasable types.md`, `1.2. Why Types Matter correctness docs refactoring.md`, `1.3. History and 5.6 Era what is stable now.md` (per Template B promises: Definition/Problem/Modern, Tradeoff/Bad/Mentor, Version/Comparison/Link).
...
- Files touched: created 3 leaf files in `01/.../1. What TypeScript...` (listed in Done); modified `README/TypeScript/LOG.md` (this entry).
