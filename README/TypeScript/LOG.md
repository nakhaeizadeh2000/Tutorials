...
- Done:
  ...
  - [unit 14] Created leaf `03/sections/7. Overlaps to avoid/7.1. Boundaries what is covered elsewhere.md` (DRY stop-list: JS mechanics → JS track; objects → 04; unions/narrowing → 07; enums → 01/11; generics/utility → 08/09; config → 13; literal composition forwarded) — verified links 0 broken inside leaf
- Decisions:
