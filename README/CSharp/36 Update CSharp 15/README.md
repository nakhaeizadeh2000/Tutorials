...
### [1.1. Feature strategy for modern C# (language vs libraries vs runtime)](<../01 Fundamental Theories/sections/7. CSharp versions/7.2. Feature strategy for modern CSharp.md>)
...
### [2.1. Collection expressions — spread / `with` on collections](<../20 Arrays/sections/2. Creating Arrays/2.1. Creating arrays initialization forms including modern collection expressions.md>)
...
3. **Overlap**: [Update C# 12](<../33 Update CSharp 12/README.md>) §2.1 (collection expressions baseline)
...
### [3.1. Primary constructors + `required` members (initialization contracts)](<../07 Constructors/sections/2. Constructor kinds/2.2. Primary constructors and required members.md>)
...
### [3.2. Pattern matching catalog (C# 9–15)](<../02 CSharp language basics/sections/5. Branching and decision making/5.4. Pattern matching catalog type relational property list slice var (CSharp 9 through 15).md>)

1. **Single place** to extend when new pattern forms ship
2. **Cross-version**: pair with [Update C# 9](<../30 Update CSharp 9/README.md>) §5
