...
### [1.1. Raw string literals (`""" ... """`)](<../String and DateTime and Math/sections/2. How String Objects are Created/2.4. Raw string literals CSharp 11 triple quotes.md>)
...
### [2.1. List patterns / slice patterns / `var` patterns](<../CSharp language basics/sections/5. Branching and decision making/5.4. Pattern matching catalog type relational property list slice var (CSharp 9 through 15).md>)
...
3. **Also**: [Update C# 9](<../Update CSharp 9/README.md>) §5 for foundational patterns

## 3. Type visibility and encapsulation

### [3.1. File-local types (C# 11) vs nested types](<../Extension Methods and others/sections/6. Nested types/6.4. File-local types vs nested types.md>)
...
### [4.1. `required` members (and how they relate to constructors)](<../Constructors/sections/2. Constructor kinds/2.2. Primary constructors and required members.md>)
...
### [5.1. Auto-default structs (`default(T)` vs parameterless ctor)](<../Structures/sections/1. Structures fundamentals/1.4. Auto default structs default T vs parameterless constructors.md>)
...
### [5.2. `ref` fields + `scoped` (C# 11+)](<../Structures/sections/4. Readonly structs/4.3. ref fields scoped ref safety and CSharp 11.md>)
...
1. **UTF-8 string literals**, **generic math** (`static` abstract in interfaces): see [Abstract Classes 3.3](<../Abstract Classes and Interfaces/sections/3. Interfaces/3.3. Static abstract members in interfaces generic math.md>)
2. **Required members**: [Constructors 2.2](<../Constructors/sections/2. Constructor kinds/2.2. Primary constructors and required members.md>); **file-local types**: [Extension Methods 6.4](<../Extension Methods and others/sections/6. Nested types/6.4. File-local types vs nested types.md>)
