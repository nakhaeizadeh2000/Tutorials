...
### [1.1. `params` collections (C# 13+)](<../Methods/sections/6. Parameter modifiers and ref-like patterns/6.7. params parameters variable argument lists.md>)
...
3. **Domain map**: [Methods](<../Methods/README.md>) §6.7

## 2. Properties and indexers

### [2.1. Partial properties and indexers](<../Partial and Static Classes, Enumerations/sections/1. Partial types/1.4. Partial properties and indexers CSharp 13.md>)

1. **Source generators** and split implementation files
2. **Pair with**: [Properties and Indexers](<../Properties and Indexers/README.md>) for accessor semantics

### [2.2. Implicit index access in object initializers (`^`)](<../Properties and Indexers/sections/4. Auto-properties with accessor accessibility/4.3. Implicit index access from end in object initializers CSharp 13.md>)
...
### [3.1. `field` contextual keyword (property backing field)](<../Properties and Indexers/sections/2. Creating properties/2.3. field keyword backing fields property accessors CSharp 13 14.md>)

1. **Unifies** auto-property backing field access in accessors (C# 13+; extended in C# 14)
2. **Boundary**: conceptual “field” story also in [Fields](<../Fields/README.md>)—**keyword** details live under Properties
3. **See**: [Update C# 14](<../Update CSharp 14/README.md>) for C# 14 `field` refinements
