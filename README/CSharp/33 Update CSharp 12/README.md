...
### [1.1. Primary constructors in classes (and how they compose with `required`)](<../07 Constructors/sections/2. Constructor kinds/2.2. Primary constructors and required members.md>)
...
### [2.1. Collection expressions (modern literal-style construction)](<../20 Arrays/sections/2. Creating Arrays/2.1. Creating arrays initialization forms including modern collection expressions.md>)
...
### [3.1. Default parameters in lambda expressions](<../19 Delegates and Events/sections/7. Anonymous methods and lambdas/7.5. Lambda explicit return type default parameters modifiers (CSharp 10 through 15).md>)
...
### [4.1. Alias any type (global using aliases as a large-solution tool)](<../11 Namespaces/sections/5. Using aliases/5.2. Global using aliases and hygiene.md>)
...
4. **Overlap guardrail**: pair this with [Update C# 10](<../31 Update CSharp 10/README.md>) for **file-scoped namespaces + global usings**—this C# 12 map focuses on **alias-any-type** ergonomics and large-solution navigation.

## 5. “Other stuff new in version 12”

### 5.1. C# 12 feature pointers (index)

1. **Primary constructors** (classes/structs): [Constructors 2.2](<../07 Constructors/sections/2. Constructor kinds/2.2. Primary constructors and required members.md>); **collection expressions**: [Arrays 2.1](<../20 Arrays/sections/2. Creating Arrays/2.1. Creating arrays initialization forms including modern collection expressions.md>)
