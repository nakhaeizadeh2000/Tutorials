...
### [7.5. Lambda explicit return type, default parameters, and parameter modifiers (C# 10?C# 15)](<./sections/7. Anonymous methods and lambdas/7.5. Lambda explicit return type default parameters modifiers (CSharp 10 through 15).md>)
...
3. **Perf**: `static` lambdas + fewer delegate allocations
